...
//hello world route
router.get('/v1/hello', function(request, response) {
  response.send('Hello World');
});

//hello world route - GET paramters
router.get('/v1/helloGet', function(request, response) {
  ...
  {
    response.send('Hello ' + get_params.name);
  }
});
